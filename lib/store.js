...
const DEFAULT_STEPS = [
  { id: "brief", label: "Trao đổi Brief", status: "pending", client_note: "" },
  { id: "contract", label: "Ký kết Hợp đồng", status: "pending", client_note: "" },
  { id: "payment_1", label: "Thanh toán Đợt 1", status: "pending", client_note: "" },
  { id: "phase_1", label: "Hạng mục 1 — Build Up", status: "pending", client_note: "" },
  { id: "review_1", label: "Review Hạng mục 1", status: "pending", client_note: "" },
  { id: "phase_2", label: "Hạng mục 2 — Fix & Custom", status: "pending", client_note: "" },
  { id: "review_2", label: "Review Hạng mục 2", status: "pending", client_note: "" },
  { id: "phase_3", label: "Hạng mục 3 — Tối ưu & Deploy", status: "pending", client_note: "" },
  { id: "review_3", label: "Review Hạng mục 3", status: "pending", client_note: "" },
  { id: "payment_2", label: "Thanh toán Đợt 2", status: "pending", client_note: "" },
  { id: "done", label: "Hoàn Thành ✓", status: "pending", client_note: "" },
];
